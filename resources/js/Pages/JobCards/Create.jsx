                    ...
                    <div className="bg-white overflow-hidden shadow-md sm:rounded-xl border border-gray-100">
                        ...
                        <div className="px-6 py-4 border-b border-gray-100 bg-gradient-to-r from-indigo-50 to-purple-50">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-sm font-semibold text-gray-800">New Job Card</h3>
                                    <p className="text-xs text-gray-500">Create a job card to track service tasks</p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="bg-gray-50 p-4 rounded-xl border border-gray-100">
                                <div className="flex justify-between items-center mb-4">
                                    <div>
                                        ...
                                        <p className="text-xs text-gray-500 mt-0.5">Add parts required for this job</p>
                                    </div>
                                    <button
                                        type="button"
                                        onClick={addPartRow}
                                ...
                                {data.parts.length === 0 ? (
                                    <div className="text-center py-6 bg-white rounded-lg border border-gray-200 border-dashed">
                                        <p className="text-sm text-gray-400 font-medium">No parts added yet.</p>
                                    </div>
                                ) : (
