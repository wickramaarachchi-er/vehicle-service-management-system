                ...
                <div className="max-w-3xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white overflow-hidden shadow-sm sm:rounded-lg p-6">
                        ...
                        <div className="mb-4 p-3 bg-gray-50 rounded-md text-sm text-gray-600">
                            <strong>Vehicle:</strong> {jobCard.booking.vehicle.registration_no} — {jobCard.booking.customer.name}
                        </div>
                        ...
                        <form onSubmit={submit} className="space-y-4">
                            ...
                            <div>
                                <label className="block text-sm font-medium text-gray-700">Job Summary / Notes</label>
                                <textarea
                                    value={data.summary}
                                    ...
                                    rows="3"
                                />
                                {errors.summary && <div className="text-red-600 text-sm mt-1">{errors.summary}</div>}
                            </div>
