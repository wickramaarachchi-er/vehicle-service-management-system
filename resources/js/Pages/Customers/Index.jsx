            ...
            <div className="py-8">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: "url('/images/banners/customers-banner.jpg.png')",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}
                    >
                        {/* Semi-transparent gradient overlay */}
                        <div className="absolute inset-0 pointer-events-none" style={{ background: 'linear-gradient(to right, rgba(79,70,229,0.72), rgba(59,130,246,0.68))' }}></div>
                        ...
                        <div className="px-8 py-8 md:py-10 relative z-10 flex items-center gap-6">
                            ...
                            <div>
                                ...
                                <p className="mt-1 text-white/80 text-sm md:text-base font-medium">Manage your customer records and contact details.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table className="min-w-full">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {customers.data.map((customer) => (
                                        <tr key={customer.id} className="hover:bg-indigo-50/40 transition-colors group">
                                        ...
                                        <tr>
                                            <td colSpan="5" className="px-6 py-16 text-center">
                                                <div className="flex flex-col items-center gap-3">
                                                    ...
                                                    <p className="text-xs text-gray-400">Try adjusting your search, or add a new customer to get started.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
