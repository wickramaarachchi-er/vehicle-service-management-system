            ...
            <div className="py-8">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    ...
                    <div
                        ...
                        style={{
                            backgroundImage: "url('/images/banners/mechanics-banner.jpg.png')",
                            backgroundSize: 'cover',
                            backgroundPosition: 'center',
                        }}
                    >
                        {/* Semi-transparent gradient overlay */}
                        <div className="absolute inset-0 pointer-events-none" style={{ background: 'linear-gradient(to right, rgba(249,115,22,0.72), rgba(245,158,11,0.68))' }}></div>
                        ...
                        <div className="px-8 py-8 md:py-10 relative z-10 flex items-center gap-6">
                            ...
                            <div>
                                <h1 className="text-3xl font-extrabold text-white tracking-tight">Mechanics</h1>
                                <p className="mt-1 text-white/80 text-sm md:text-base font-medium">Manage staff, assignments, and mechanic profiles.</p>
                            </div>
                        </div>
                    </div>
                            ...
                            <table className="min-w-full">
                                ...
                                <tbody className="divide-y divide-gray-100">
                                    {mechanics.data.map((mechanic) => (
                                        <tr key={mechanic.id} className="hover:bg-indigo-50/40 transition-colors group">
                                            <td className="px-6 py-4 text-sm font-medium text-gray-800">{mechanic.name}</td>
                                        ...
                                        <tr>
                                            <td colSpan="5" className="px-6 py-16 text-center">
                                                <div className="flex flex-col items-center gap-3">
                                                    ...
                                                    <p className="text-sm font-medium text-gray-500">No mechanics found</p>
                                                    <p className="text-xs text-gray-400">Try adjusting your search, or add a new mechanic to get started.</p>
                                                </div>
                                            </td>
                                        </tr>
                                    )}
